...
export const demoProject: GigSheetProject = {
  ...
  lightingEquipment: [
    { id: fixtureIds.parL, type: 'PAR', name: 'PAR Gauche', dmxStart: 1, dmxChannels: 4, position: 'Truss gauche', stageX: 20, stageY: 10, notes: '' },
    { id: fixtureIds.parR, type: 'PAR', name: 'PAR Droit', dmxStart: 5, dmxChannels: 4, position: 'Truss droite', stageX: 80, stageY: 10, notes: '' },
    { id: fixtureIds.parC, type: 'PAR', name: 'PAR Centre', dmxStart: 9, dmxChannels: 4, position: 'Truss centre', stageX: 50, stageY: 10, notes: '' },
    { id: fixtureIds.washL, type: 'WASH', name: 'Wash Gauche', dmxStart: 13, dmxChannels: 7, position: 'Sol cour', stageX: 15, stageY: 55, notes: '' },
    { id: fixtureIds.washR, type: 'WASH', name: 'Wash Droit', dmxStart: 20, dmxChannels: 7, position: 'Sol jardin', stageX: 85, stageY: 55, notes: '' },
    { id: fixtureIds.strobe, type: 'STROBE', name: 'Strobe', dmxStart: 27, dmxChannels: 2, position: 'Truss centre', stageX: 50, stageY: 5, notes: 'Utiliser avec parcimonie' },
  ],
  lightingScript: {
    [songIds.s1]: {
      mood: 'Montée progressive — bleu vers ambre',
      cues: [
        { id: id(), moment: 'Intro', fixtureId: fixtureIds.washL, r: 0, g: 30, b: 180, w: 0, intensity: 40, notes: 'Bleu diffus' },
        { id: id(), moment: 'Intro', fixtureId: fixtureIds.washR, r: 0, g: 30, b: 180, w: 0, intensity: 40, notes: '' },
        { id: id(), moment: 'Couplet 1', fixtureId: fixtureIds.parL, r: 200, g: 120, b: 0, w: 0, intensity: 60, notes: '' },
        { id: id(), moment: 'Refrain', fixtureId: fixtureIds.parC, r: 245, g: 158, b: 11, w: 20, intensity: 100, notes: 'Full ambre' },
      ],
    },
    [songIds.s5]: {
      mood: 'Énergie maximale — rouge et strobe',
      cues: [
        { id: id(), moment: 'Couplet', fixtureId: fixtureIds.parL, r: 220, g: 0, b: 0, w: 0, intensity: 80, notes: '' },
        { id: id(), moment: 'Couplet', fixtureId: fixtureIds.parR, r: 220, g: 0, b: 0, w: 0, intensity: 80, notes: '' },
        { id: id(), moment: 'Refrain', fixtureId: fixtureIds.strobe, r: 255, g: 255, b: 255, w: 100, intensity: 100, notes: 'Burst court' },
      ],
    },
    [songIds.s9]: {
      mood: 'Intimiste — blanc chaud, spots seuls',
      cues: [
        { id: id(), moment: 'Toute la chanson', fixtureId: fixtureIds.parC, r: 255, g: 200, b: 100, w: 60, intensity: 50, notes: 'Spot seul sur Julie' },
      ],
    },
    [songIds.s10]: {
      mood: 'Grand final — toutes couleurs, crescendo',
      cues: [
        { id: id(), moment: 'Intro', fixtureId: fixtureIds.washL, r: 100, g: 0, b: 200, w: 0, intensity: 60, notes: '' },
        { id: id(), moment: 'Intro', fixtureId: fixtureIds.washR, r: 200, g: 0, b: 100, w: 0, intensity: 60, notes: '' },
        { id: id(), moment: 'Refrain final', fixtureId: fixtureIds.parL, r: 255, g: 200, b: 0, w: 50, intensity: 100, notes: '' },
        { id: id(), moment: 'Refrain final', fixtureId: fixtureIds.parR, r: 255, g: 200, b: 0, w: 50, intensity: 100, notes: '' },
        { id: id(), moment: 'Refrain final', fixtureId: fixtureIds.parC, r: 255, g: 255, b: 255, w: 100, intensity: 100, notes: 'Full blast' },
        { id: id(), moment: 'Outro', fixtureId: fixtureIds.strobe, r: 255, g: 255, b: 255, w: 100, intensity: 100, notes: 'Strobe final 3sec' },
      ],
    },
  },
};
